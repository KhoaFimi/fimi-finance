...
import SecurityPolicy from '@/app/(main)/_components/policies/security-policy'
import TermPolicy from '@/app/(main)/_components/policies/term-policy'
import UserPolicy from '@/app/(main)/_components/policies/user-policy'
